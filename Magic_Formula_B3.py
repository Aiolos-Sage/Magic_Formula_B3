...
def get_financial_data(ticker):
    try:
        ...
        keymetrics_url = f"https://financialmodelingprep.com/api/v3/key-metrics/{ticker}?period=annual&limit=1&apikey={API_KEY}"
...
# === UI Content ===
if language == "PT-BR":
    st.title("📈 Fórmula Mágica - Ações B3")
    ...
    st.title("📈 Magic Formula - B3 Stocks")
